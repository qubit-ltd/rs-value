...
use qubit_value::{ValueContainer, ValueWireDecodeError, ValueWireLimits, ValueWirePayloadV1};
...
fn test_value_wire_payload_v1_decode_json_slice_honors_limits() {
    ...
    let payload =
        ValueWirePayloadV1::decode_json_slice_with_limits(input, ValueWireLimits::new(input.len()))
