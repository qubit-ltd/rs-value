...
macro_rules! for_each_value_type {
    ($macro:ident $(, $arg:expr)*) => {
        $macro! {
            ...
            ([cfg(feature = "big-integer")], BigInteger, ::num_bigint::BigInt, ::qubit_datatype::DataType::BigInteger, clone, json_string, "Arbitrary-precision integer", "Arbitrary-precision integer list"),
            ([cfg(feature = "big-decimal")], BigDecimal, ::bigdecimal::BigDecimal, ::qubit_datatype::DataType::BigDecimal, clone, json_string, "Arbitrary-precision decimal", "Arbitrary-precision decimal list"),
